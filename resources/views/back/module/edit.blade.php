...
<div class="animsition">
    ...
    <!-- PAGE TITLE -->
        ...
        <div class="container-fluid">
            <div class="row">
                @include('back.module.nav')
                <section class="panel panel-danger">
                    <header class="panel-heading">
                        <h4 class="panel-title">修改模块</h4>
                    </header>
                    <div class="panel-body">
                        @include('back.public.form_request')
                        <form action="{{ url('back/module/update/'.$module->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="list" value="{{ $module->list }}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" >文档模板:</label>
                                <input type="text" name="article" value="{{ $module->article }}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" >封面模板:</label>
                                <input type="text" name="cover" value="{{ $module->cover }}" class="form-control">
                            </div>
